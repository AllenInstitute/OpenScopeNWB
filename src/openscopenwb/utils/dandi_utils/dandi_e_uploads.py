...
def automatic_dandi_upload( nwb_folder_path, dandiset_id, session_id, project_id, subject_id):
...
if __name__ == "__main__":
    ...
    automatic_dandi_upload(nwb_folder_path, dandiset_id, session_id, project_id, subject_id)
